return {
	...
	config = function()
		...
		-- Use `:Mason` to check status or install other tools
		-- `g?` with menu open for help
		require("mason").setup()

		-- Setup ensure_installed based on server keys. Other tools
		-- can be added manually with `vim.list_extend`
		...
		require("mason-lspconfig").setup({
			handlers = {
				function(server_name)
					...
					-- override only values explicitly passed in
					-- the server configuration above. Useful for
